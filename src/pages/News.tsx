      ...
      {mode !== "social" && (
        <section className="sw-section">
          <div className="sw-container">
            ...
            >
              <EditableText as="h3" style={{ fontSize: "var(--fs-h3)" }} k="page.news.socialHeading" value="Never miss an update" />
              <EditableText
                as="p"
                className="sw-lead"
                style={{ margin: "0.5rem auto 1.25rem", maxWidth: "48ch" }}
                k="page.news.socialBody"
                value="The fastest way to keep up with match-day, results and club news is on our socials."
              />
