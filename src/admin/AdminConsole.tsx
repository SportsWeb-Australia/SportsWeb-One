...
const CLUB_SUB: Record<string, SubItem[]> = {
  ...
  __members: [
    ...
    ["__injuries", "Injuries & concussion", "vault"],
  ],
  __comms: [
...
const CLUB_APP_OF: Record<string, string> = {
  ...
  __members: "__members", __people: "__members", __reports_members: "__members", __compliance: "__members", __injuries: "__members",
...
export function AdminConsole({ active, setActive, can, openZoho, signOut, email, roleLabel, workspace, screen, mode = "platform", crumbRoot, actingAs, onExit }: Props) {
  ...
  const CLUB_GROUPS = [
    ...
    { id: "people", title: "People & teams", color: "var(--c-operate)", cards: [
      ...
      scr("__injuries", "Injuries & concussion", "Incidents, return-to-play stages and clearances.", "vault", "var(--c-crit)", can("club.content")),
    ] },
